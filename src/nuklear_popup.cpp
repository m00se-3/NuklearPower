...
NK_API void
nk_popup_get_scroll(const struct nk_context *ctx, unsigned int *offset_x, unsigned int *offset_y)
{
    struct nk_window *popup;
...
NK_API void
nk_popup_set_scroll(struct nk_context *ctx, unsigned int offset_x, unsigned int offset_y)
{
    struct nk_window *popup;
