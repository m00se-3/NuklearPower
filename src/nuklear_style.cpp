...
NK_API bool NK_STYLE_PUSH_IMPLEMENATION(struct nk, style_item, style_items)
NK_API bool NK_STYLE_PUSH_IMPLEMENATION(nk,float, floats)
NK_API bool NK_STYLE_PUSH_IMPLEMENATION(struct nk, vec2, vectors)
NK_API bool NK_STYLE_PUSH_IMPLEMENATION(nk,flags, flags)
NK_API bool NK_STYLE_PUSH_IMPLEMENATION(struct nk,color, colors)

NK_API bool NK_STYLE_POP_IMPLEMENATION(style_item, style_items)
NK_API bool NK_STYLE_POP_IMPLEMENATION(float,floats)
NK_API bool NK_STYLE_POP_IMPLEMENATION(vec2, vectors)
NK_API bool NK_STYLE_POP_IMPLEMENATION(flags,flags)
NK_API bool NK_STYLE_POP_IMPLEMENATION(color,colors)
