...
nk_group_scrolled_offset_begin(struct nk_context *ctx,
    unsigned int *x_offset, unsigned int *y_offset, const char *title, nk_flags flags)
{
...
NK_API void
nk_group_get_scroll(struct nk_context *ctx, const char *id, unsigned int *x_offset, unsigned int *y_offset)
{
    int id_len;
    nk_hash id_hash;
    struct nk_window *win;
...
NK_API void
nk_group_set_scroll(struct nk_context *ctx, const char *id, unsigned int x_offset, unsigned int y_offset)
{
    int id_len;
    nk_hash id_hash;
    struct nk_window *win;
