...
nk_draw_selectable(struct nk_command_buffer *out,
    nk_flags state, const struct nk_style_selectable *style, bool active,
...
nk_do_selectable(nk_flags *state, struct nk_command_buffer *out,
    struct nk_rect bounds, const char *str, int len, nk_flags align, bool *value,
...
nk_selectable_image_text(struct nk_context *ctx, struct nk_image img,
    const char *str, int len, nk_flags align, bool *value)
{
    struct nk_window *win;
    struct nk_panel *layout;
    const struct nk_input *in;
...
nk_selectable_symbol_label(struct nk_context *ctx, enum nk_symbol_type sym,
    const char *title, nk_flags align, bool *value)
{
    return nk_selectable_symbol_text(ctx, sym, title, nk_strlen(title), align, value);
}
NK_API bool nk_select_text(struct nk_context *ctx, const char *str, int len,
    nk_flags align, bool value)
{
    nk_selectable_text(ctx, str, len, align, &value);return value;
}
NK_API bool nk_selectable_label(struct nk_context *ctx, const char *str, nk_flags align, bool *value)
{
    return nk_selectable_text(ctx, str, nk_strlen(str), align, value);
}
NK_API bool nk_selectable_image_label(struct nk_context *ctx,struct nk_image img,
    const char *str, nk_flags align, bool *value)
{
    return nk_selectable_image_text(ctx, img, str, nk_strlen(str), align, value);
}
NK_API bool nk_select_label(struct nk_context *ctx, const char *str, nk_flags align, bool value)
{
    nk_selectable_text(ctx, str, nk_strlen(str), align, &value);return value;
}
NK_API bool nk_select_image_label(struct nk_context *ctx, struct nk_image img,
    const char *str, nk_flags align, bool value)
{
    nk_selectable_image_text(ctx, img, str, nk_strlen(str), align, &value);return value;
}
NK_API bool nk_select_image_text(struct nk_context *ctx, struct nk_image img,
    const char *str, int len, nk_flags align, bool value)
{
...
nk_select_symbol_text(struct nk_context *ctx, enum nk_symbol_type sym,
    const char *title, int title_len, nk_flags align, bool value)
{
