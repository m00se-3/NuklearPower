...
nk_draw_checkbox(struct nk_command_buffer *out,
    nk_flags state, const struct nk_style_toggle *style, bool active,
...
nk_do_toggle(nk_flags *state,
    ...
    bool *active, const char *str, int len, enum nk_toggle_type type,
 ...
 * --------------------------------------------------------------*/
NK_API bool
nk_check_text(struct nk_context *ctx, const char *text, int len, bool active)
{
...
NK_API bool
nk_check_text_align(struct nk_context *ctx, const char *text, int len, bool active, nk_flags widget_alignment, nk_flags text_alignment)
{
    struct nk_window *win;
    struct nk_panel *layout;
    const struct nk_input *in;
...
NK_API bool
nk_checkbox_text(struct nk_context *ctx, const char *text, int len, bool *active)
{
    int old_val;
    NK_ASSERT(ctx);
    NK_ASSERT(text);
...
NK_API bool
nk_checkbox_text_align(struct nk_context *ctx, const char *text, int len, bool *active, nk_flags widget_alignment, nk_flags text_alignment)
{
    int old_val;
    NK_ASSERT(ctx);
    NK_ASSERT(text);
...
NK_API bool nk_check_label(struct nk_context *ctx, const char *label, bool active)
{
...
NK_API bool nk_checkbox_label(struct nk_context *ctx, const char *label, bool *active)
{
...
NK_API bool nk_checkbox_flags_label(struct nk_context *ctx, const char *label,
    unsigned int *flags, unsigned int value)
{
 ...
 * --------------------------------------------------------------*/
NK_API bool
nk_option_text(struct nk_context *ctx, const char *text, int len, bool is_active)
{
    struct nk_window *win;
    struct nk_panel *layout;
    const struct nk_input *in;
...
NK_API bool
nk_option_text_align(struct nk_context *ctx, const char *text, int len, bool is_active, nk_flags widget_alignment, nk_flags text_alignment)
{
    struct nk_window *win;
    struct nk_panel *layout;
    const struct nk_input *in;
...
NK_API bool
nk_radio_text(struct nk_context *ctx, const char *text, int len, bool *active)
{
    int old_value;
    NK_ASSERT(ctx);
    NK_ASSERT(text);
...
NK_API bool
nk_radio_text_align(struct nk_context *ctx, const char *text, int len, bool *active, nk_flags widget_alignment, nk_flags text_alignment)
{
    int old_value;
    NK_ASSERT(ctx);
    NK_ASSERT(text);
...
NK_API bool
nk_option_label(struct nk_context *ctx, const char *label, bool active)
{
    return nk_option_text(ctx, label, nk_strlen(label), active);
}
NK_API bool
nk_option_label_align(struct nk_context *ctx, const char *label, bool active, nk_flags widget_alignment, nk_flags text_alignment)
{
    return nk_option_text_align(ctx, label, nk_strlen(label), active, widget_alignment, text_alignment);
}
NK_API bool
nk_radio_label(struct nk_context *ctx, const char *label, bool *active)
{
    return nk_radio_text(ctx, label, nk_strlen(label), active);
}
NK_API bool
nk_radio_label_align(struct nk_context *ctx, const char *label, bool *active, nk_flags widget_alignment, nk_flags text_alignment)
{
