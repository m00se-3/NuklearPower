...
namespace nk {
      ...
      float border_width, const struct user_font *font)
  {
    switch (type) {
      ...
      case symbol_type::SYMBOL_MINUS: {
        ...
        const char *X = (type == symbol_type::SYMBOL_X) ? "x":
            (type == symbol_type::SYMBOL_UNDERSCORE) ? "_":
      ...
      case symbol_type::SYMBOL_TRIANGLE_RIGHT: {
        ...
        heading = (type == symbol_type::SYMBOL_TRIANGLE_RIGHT) ? heading::RIGHT :
            (type == symbol_type::SYMBOL_TRIANGLE_LEFT) ? heading::LEFT
                                                                    :
            (type == symbol_type::SYMBOL_TRIANGLE_UP) ? heading::UP : heading::DOWN;
      ...
      case symbol_type::SYMBOL_TRIANGLE_RIGHT_OUTLINE: {
        enum heading heading;
        struct vec2f points[3];
        heading = (type == symbol_type::SYMBOL_TRIANGLE_RIGHT_OUTLINE) ? heading::RIGHT :
            (type == symbol_type::SYMBOL_TRIANGLE_LEFT_OUTLINE) ? heading::LEFT :
            (type == symbol_type::SYMBOL_TRIANGLE_UP_OUTLINE) ? heading::UP : heading::DOWN;
        triangle_from_direction(points, content, 0, 0, heading);
      ...
      case symbol_type::SYMBOL_MAX: break;
    }
  }
  NK_LIB bool
    ...
    if (input_is_mouse_hovering_rect(i, r)) {
      *state = NK_WIDGET_STATE_HOVERED;
      ...
      if (input_has_mouse_click_in_button_rect(i, NK_BUTTON_LEFT, r)) {
        ret = (behavior != btn_behavior::BUTTON_DEFAULT) ?
            input_is_mouse_down(i, NK_BUTTON_LEFT):
      ...
      flag text_alignment, const struct user_font *font)
  {
    ...
    else text.txt = style->text_normal;
