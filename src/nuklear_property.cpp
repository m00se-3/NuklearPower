    ...
    float inc_per_pixel)
{
    ...
    int left_mouse_click_in_cursor = in &&
        nk_input_has_mouse_click_down_in_rect(in, NK_BUTTON_LEFT, drag, true);
    ...
    float inc_per_pixel)
{
    ...
    if (in && *state == NK_PROPERTY_DEFAULT) {
        ...
        else if (nk_input_is_mouse_click_down_in_rect(in, NK_BUTTON_LEFT, label, true))
            *state = NK_PROPERTY_DRAG;
        else if (nk_input_is_mouse_click_down_in_rect(in, NK_BUTTON_LEFT, empty, true))
            *state = NK_PROPERTY_DRAG;
    }
