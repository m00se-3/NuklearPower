...
nk_progress_behavior(nk_flags *state, struct nk_input *in,
    struct nk_rect r, struct nk_rect cursor, std::size_t max, std::size_t value, bool modifiable)
{
...
nk_draw_progress(struct nk_command_buffer *out, nk_flags state,
    ...
    const struct nk_rect *scursor, std::size_t value, std::size_t max)
{
...
NK_API bool
nk_progress(struct nk_context *ctx, std::size_t *cur, std::size_t max, bool is_modifyable)
{
...
NK_API std::size_t
nk_prog(struct nk_context *ctx, std::size_t cur, std::size_t max, bool modifyable)
{
